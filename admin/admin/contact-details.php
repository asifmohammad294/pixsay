...
$sql = "SELECT tblcontactdata.FullName,tblcontactdata.PhoneNumber,tblcontactdata.UserIp,tblcontactdata.EmailId,tblcontactdata.Subject,tblcontactdata.Message,tblcontactdata.PostingDate,tblcontactdata.id,tblcontactdata.City,tbladminremarks.adminRemark,tbladminremarks.remarkDate from tblcontactdata left join  tbladminremarks on  tbladminremarks.contactFormId=tblcontactdata.id where tblcontactdata.id=:fid";
$query = $dbh -> prepare($sql);
            ...
            <div id="invoice-customer-details" class="row pt-2">
              ...
              <div class="col-md-6 col-sm-12 text-center text-md-left">
                <ul class="px-0 list-unstyled">
                  ...
                  <li><b>City : </b><?php echo htmlentities($result->City);?></li>
              ...
              <div class="row">
                <div class="table-responsive col-sm-12">
                  ...
                  <tr>
                        ...
                        <td><p><?php echo htmlentities($result->adminRemark);?>
                        <br />
